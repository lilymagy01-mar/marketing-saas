...
export default function AdminUsersPage() {
  ...
  const users = [
    { 
      id: '1', name: '릴리맥 강남 (꽃)', email: 'owner@lilymag.kr', plan: 'Premium', 
      status: 'Active', usage: 84, successRate: 98, lastActive: '10분 전',
      joinDate: '2024.01.15'
    },
    { 
      id: '2', name: '패션허브 서울 (의류)', email: 'style@hub.com', plan: 'Premium', 
      status: 'Active', usage: 42, successRate: 92, lastActive: '2시간 전',
      joinDate: '2024.02.01'
    },
    { 
      id: '3', name: '미식가 가이드 (식당)', email: 'food@guide.cc', plan: 'Free', 
      status: 'Warning', usage: 95, successRate: 74, lastActive: '3일 전',
      joinDate: '2024.03.10'
    },
    { 
      id: '4', name: '시티 부동산 (부동산)', email: 're@city.com', plan: 'Free', 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/5 bg-white/[0.02]">
                <th className="px-8 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest leading-none">비즈니스 브랜딩</th>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        <div className="p-6 rounded-3xl bg-amber-500/5 border border-amber-500/10 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-amber-500/70 leading-relaxed font-medium">'미식가 가이드' 외 2곳의 테넌트가 7일 이내에 구독이 만료됩니다. 연장 안내 메시지를 발송할 준비를 하세요.</p>
          </div>
        </div>
        <div className="p-6 rounded-3xl bg-indigo-500/5 border border-indigo-500/10 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-500/70 leading-relaxed font-medium">'스타일 패션'의 AI 사용량이 무료 한도(90%)에 근접했습니다. 자동화 전환 프로모션을 제안하기에 최적의 타이밍입니다.</p>
          </div>
        </div>
      </div>
    </div>
